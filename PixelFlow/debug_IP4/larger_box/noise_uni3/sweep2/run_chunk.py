"""Per-GPU runner for sweep2. Same evaluation protocol as larger_box/run_chunk.py."""
import os, sys, json, time, argparse

HERE = os.path.dirname(os.path.abspath(__file__))            # sweep2
NU   = os.path.dirname(HERE)                                 # noise_uni3
LB   = os.path.dirname(NU)                                   # larger_box
...
from sweep2_configs import CONFIGS
