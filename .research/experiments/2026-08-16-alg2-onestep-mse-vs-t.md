...
| 产物 | `PixelFlowICLR/Algorithm2/results/`：alg2_mse.csv（1400 行，35 个 σ<0.01 跳过点 Alg2=NaN）、alg2_<task>.png ×5（全局 t 拼接、log-y、粗均值+细逐图；inpainting 加 obs/miss 面板）、score_gamma2.png、gamma2_meas.json、sanity.json |
