...
2211 对照（PSNR single / MMSE5 / MMSE10 / no_noise）：
...
产物：s_stats/test/{run_s4_test.py, run_single.sh, run_gpu.sh, s4_results.csv, s4_per_task.csv,
s4_per_task_numeric.csv, s4_per_task.md}。
用户决定（2026-09-03）：S 固定为 spectral_class → tasks/default-spectral-class-s.md、
